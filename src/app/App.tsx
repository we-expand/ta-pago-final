...
import { 
  LayoutDashboard, Users, Clock, Settings as SettingsIcon, Link2, 
  ShieldCheck, LogOut, Brain, Target, Fingerprint, Terminal, Bell, 
  Search, Menu, FileText, TrendingUp, User, Building2, LifeBuoy, 
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (path.startsWith('/connect/') && session) {
